        ...
        result: AnalyzeResult = llm.invoke([
            {"role": "system",
             "content": (
                 ...
                 "    1 = 의사결정·실무에 무관한 글. 인물 SNS·사옥 인테리어·라이프스타일 가십, "
                 "역사·과거 회상, 개인 의견·정치 칼럼, 교육·퀴즈, 취미 실험·hobby 프로젝트, "
                 "인물 강연·졸업식 화제, 단순 추억 회고 모두 포함.\n"
                 "    2 = 좁은 관심사·점진 업데이트. 마이너 패치, 단축키 추가, UX 미세 조정, "
                 "분석 에세이·가이드 글, 특정 도구 v0/v1 출시, 소수 사용자 SaaS 기능 추가.\n"
                 "    3 = 업계 관심사. 실무자 도구 메이저 업데이트, 라이브러리 출시, "
                 "프레임워크 회고, 자율주행·보안 운영 이슈, 산업 분석.\n"
                 "    4 = 업계 광범위 임팩트. 빅테크 제품 출시, 가격 정책 변화, "
                 "핵심 인프라 변경, 산업 공급망 영향, 대형 IPO·M&A.\n"
                 "    5 = 산업·사회에 큰 영향. 파운데이션 모델 출시, 규제 시행, 칩 세대 교체.\n"
                 "    중요: 본문에 'AI'·'LLM'·'머신러닝' 단어가 있다고 무조건 3 이상이 아니다. "
                 "글의 성격(취미·역사·의견·교육)이 의사결정과 무관하면 1점.\n"
